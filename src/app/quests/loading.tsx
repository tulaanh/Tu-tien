  ...
  return (
    <div className="space-y-6 pb-12 animate-pulse">
      ...
      <div className="rounded-2xl p-6 md:p-8 xianxia-card border border-amber-500/20 bg-slate-900/40">
        <div className="h-4 w-28 bg-amber-500/20 rounded-full mb-3" />
      ...
      <div className="rounded-3xl p-5 sm:p-6 xianxia-card border border-amber-500/20 bg-slate-900/40 space-y-4">
        <div className="flex items-center space-x-3">
          <div className="w-11 h-11 rounded-2xl bg-amber-500/20" />
      ...
      <div className="flex space-x-2">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="h-9 w-28 bg-slate-900/80 border border-slate-800 rounded-xl" />
        ))}
      </div>
